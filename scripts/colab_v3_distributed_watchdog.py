"""Keepalive and bounded process replacement for one primary-v3 run."""
...
def reconcile_processes(
    ...
    *,
    ...
    coordinator_tokens = ("colab_v3_distributed_coordinator.py", str(control / "run.json"))
    ...
    for index in range(WORKER_COUNT):
        ...
        tokens = ("colab_v3_distributed_worker.py", worker_id, str(root))
