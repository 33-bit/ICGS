"""Build v3 procedural RLBench task models from the step-driven compiler."""
...
def build_v3_models(program_ids: list[str] | None = None) -> dict:
    ...
    wanted = list(program_ids or list(compile_v3_catalog()))
...
def main() -> None:
    ...
    parser.add_argument("--programs", nargs="+", default=list(V3_PROTOCOL.pilot_program_ids))
    args = parser.parse_args()
    built = build_v3_models(args.programs)
    print("V3_MODELS_BUILT", len(built), flush=True)
