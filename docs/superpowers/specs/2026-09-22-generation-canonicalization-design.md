...
In scope are the canonical collection package, Colab generation entry points,
...
only thin semantic operational entry points. No generation worker may import a
...
uses “generation” as the operational name.
...
- focused generation, queue, validation, publication and worker tests
  pass;
