"""Historical unported occupancy pretraining. See docs; not a supported runtime entry."""
...
# Original visualization module was not supplied. Scientific code below is retained
# for audit, but construction fails explicitly rather than inventing that dependency.
...
class AutoEncoder(L.LightningModule):
    def __init__(self, local_nn_dims, local_num_freq=10, save_dir=None, save_every=1000,
        ...
        super().__init__()
        raise RuntimeError('Historical occupancy pretraining is unsupported: missing visualization source and incompatible encoder constructor; see architecture audit')
