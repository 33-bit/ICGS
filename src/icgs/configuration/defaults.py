...
from .schema import (
    ...
    DiffusionConfig, SamplingConfig, RuntimeConfig, TrainingConfig, EvaluationConfig,
)
...
def from_legacy(values):
    ...
    result = ExperimentConfig(
        ...
        evaluation=EvaluationConfig(execution_horizon=min(8,v['pre_horizon'])),
    )
...
def from_resolved(payload):
    ...
    from .schema import EvaluationConfig
