...
from icgs.data.collection.generation.batch import AttemptPlan, provenance_from_plan
from icgs.data.collection.generation.camera import wrist_camera_pose_world
...
def transitions_to_record(transitions: Sequence[Any]) -> list[dict[str, Any]]:
    rows = []
...
def assemble_episode(
    *,
    ...
    v2_transitions = transitions_to_record(transitions)
    ...
    record: dict[str, Any] = {
        "schema_version": GENERATION_PROTOCOL.episode_schema_version,
