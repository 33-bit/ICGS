...
_OPTIONAL_PROVENANCE = (
    ...
    "train_subset",
    "scene_signature",
    *GENERATION_PROTOCOL.phase2_reserved_fields,
)
_OUTCOMES = frozenset(GENERATION_PROTOCOL.outcome_classes)
...
def validate_episode(record: Mapping[str, Any]) -> None:
    ...
    if record.get("schema_version") != GENERATION_PROTOCOL.episode_schema_version:
