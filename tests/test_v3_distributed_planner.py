...
from icgs.data.collection.v3.distributed_contracts import RunConfig, WorkerResult
...
def _rows() -> dict[str, dict]:
    data = json.loads(Path("artifacts/composition/approved_composition_manifest_v3.json").read_text())
